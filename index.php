<?php require_once('header.php') ?>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-caption mb-50">
                        ...
                        <div class="section-tittle mb-35">
                            ...
                            <h2>Authorized Service Provider for Registration of Leave and License Agreement.</h2>
                        </div>
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <div class="about-img ">
                        <!-- <div class="about-font-img d-none d-lg-block">
                            <img src="assets/img/gallery/about2.jpg" width="400" alt="">
                        </div> -->
                        <div class="about-back-img ">
                            <img src="assets/img/gallery/about1.jpg" width="550" height="500" style="padding-top:100px;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    ...
                    <div class="section-tittle section-tittle2 text-center mb-45">
                        <span>For schedule an appointment</span>
                        <h2>Ready for quick & hassle-free registration?</h2>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
                <div class="align-items-center">
                    ...
                    <a href="tel:+91-983-339-2177" class="btn white-btn">+91 983 339 2177 </a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-10">
                    ...
                    <div class="section-tittle text-center mb-80">
                        ...
                        <h2>Simplifying the Renting process for both.</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-cat single-cat2 text-center mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">One Stop Solution</a></h5>
                            <p>A single platform which ensures any tedious requirements are delivered at single call or connect</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-cat single-cat2 text-center mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">Ease of Registration</a></h5>
                            <p>You can register from the ease of your home with our doorstep service.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-cat single-cat2 text-center mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">Paperless Transaction</a></h5>
                            <p>Technology focused company that insists on data management without manual intervention.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-cat single-cat2 text-center mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="services.html">No Need To Visit Registrar Office</a></h5>
                            <p>We execute and deliver service at location of your choice.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
    ...
    <!-- Service Section End -->
    <!-- Testimonial Start -->
    <div class="testimonial-area t-bg testimonial-padding p-5">
        <div class="container ">
